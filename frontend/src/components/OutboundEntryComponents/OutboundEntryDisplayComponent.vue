...
<!--                    <v-text-field-->
<!--                                  v-model="form.deliveryTypeOptions"-->
<!--                                  label="提货方式"-->
<!--                                  hide-details="auto"-->
<!--                                  outlined-->
<!--                                  readonly-->
...
<!--                    </InboundQueryPurchaseEntry>-->
            ...
            <v-col v-if="enabledFields.quoteSave">
                <v-btn color="primary"
                       @click="">
                    存为报价单
                </v-btn>
            </v-col>
            <v-col v-if="enabledFields.salesOrderSave">
                <v-btn color="primary"
                       @click="">
                    存为销售订单
                </v-btn>
