<template>
    ...
    <div id="all">
        <el-row>
            <strong>入库结账后退货</strong>
        </el-row>
        <el-form>
            <el-form-item>
                <label style="margin-right: 5px">入库结账日期</label>
                <el-date-picker
                        v-model="value2"
                        type="date"
                        placeholder="选择日期"
            ...
            <el-form-item>
                <label style="margin-right: 5px">付款方式</label>
        ...
        <el-row>
            <label style="margin-right: 5px">请输入入库结账单据号</label>
