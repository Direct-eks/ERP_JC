<template>
    ...
    <v-card outlined>
        <v-toolbar flat>
            <v-toolbar-title>结账未开票查询</v-toolbar-title>
...
export default {
    ...
    methods: {
        ...
        querySummary() {
            this.$getRequest(this.$api.notYetInvoiceSummary).then((res) => {
        ...
        summaryTableClick(val) {
            ...
            this.$getRequest(this.$api.notYetInvoiceDetail +
